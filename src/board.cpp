...
int Board::move_up_T(int color,int form,int Board_width,int Board_height)
{
    if(form==0)
    {
        b[get<0>(posa)] [get<01>(posa)]=0;
        ...
        help_tuple1= make_tuple(get<0>(posa)-1,get<01>(posa) +1);
        help_tuple2= make_tuple(get<0>(posa),get<01>(posa) +1);
        help_tuple3= make_tuple(get<0>(posa)+1,get<01>(posa) +1);
        help_tuple4= make_tuple(get<0>(posa),get<01>(posa)+2);
    ...
    else if(form==3)
    {
        if(get<01>(posa)<Board_width-1)
        {
            ...
            help_tuple2= make_tuple(get<0>(posa)+1,get<01>(posa));
            help_tuple3= make_tuple(get<0>(posa)+1,get<01>(posa)+1);
            help_tuple4= make_tuple(get<0>(posa)+2,get<01>(posa));
